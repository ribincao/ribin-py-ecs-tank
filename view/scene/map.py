...
class Test(object):
    ...
    def get_tank_item(self, name, position):
        ...
        if name == "grass":
            ...
            item["boxcollider"] = {}
            item["boxcollider"]["layer"] = 2
            item["boxcollider"]["height"] = 60
            item["boxcollider"]["width"] = 60
            item["transform"] = {}
            ...
            item["boxcollider"] = {}
            item["boxcollider"]["layer"] = 1
            item["boxcollider"]["height"] = 15
            item["boxcollider"]["width"] = 15
            item["transform"] = {}
