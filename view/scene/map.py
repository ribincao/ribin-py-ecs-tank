...
class Test(object):
    ...
    def get_tank_item(self, name, position):
        ...
        if name == "grass":
            ...
            item["box2d_collider"] = {}
            item["box2d_collider"]["layer"] = 2
            item["box2d_collider"]["height"] = 60
            item["box2d_collider"]["width"] = 60
            item["transform"] = {}
            ...
            item["box2d_collider"] = {}
            item["box2d_collider"]["layer"] = 1
            item["box2d_collider"]["height"] = 15
            item["box2d_collider"]["width"] = 15
            item["transform"] = {}
